    ...
    <>
      ...
      <ScrollView ref={scrollRef}>
        ...
        <SpaceView pt={48} viewStyle={styles.container}>
          ...
          <SpaceView
            mb={40}
            mt={15}
            viewStyle={[layoutStyle.row, layoutStyle.wrap]}
          >
            ...
            <View style={[styles_m.profileContainer]}>
              ...
              <SpaceView viewStyle={layoutStyle.alignCenter} mb={29}>
                ...
                >
                  ...
                  {'\n'}
                  <CommonText fontWeight={'700'} color={ColorType.purple}>
                    {data.memberBase?.face_code_name !== null
                      ? data.memberBase?.face_code_name
                      : ''}
                  </CommonText>
                  {'\n'}
                  매력있다고 생각하세요.
              ...
              <SpaceView mb={16}>
                ...
                >
                  <SpaceView mb={4} viewStyle={_styles.colCenter}>
                    <CommonText>
                      {data.memberBase?.social_grade > 9 &&
                        '더 이상 어떤 분을 소개시켜 드려야할 지 자신이 없어요.'}
                      {data.memberBase?.social_grade > 8 &&
                        data.memberBase?.social_grade <= 9 &&
                        '꼭! 이분에게 관심을 표현하시길 바래요..!'}
                      {data.memberBase?.social_grade > 7 &&
                        data.memberBase?.social_grade <= 8 &&
                        '매칭되면 후회하지 않을 듯한 느낌이 들어요.'}
                      {data.memberBase?.social_grade > 6 &&
                        data.memberBase?.social_grade <= 7 &&
                        '좋은 분이실지도 몰라서 소개시켜드려요.'}
                      {data.memberBase?.social_grade > 5 &&
                        data.memberBase?.social_grade <= 6 &&
                        '사람의 코드는 예상치 못 하게 맞는 법이잖아요? 조심스럽게 소개시켜드려요.'}
                      {data.memberBase?.social_grade > 4 &&
                        data.memberBase?.social_grade <= 5 &&
                        '신중한 관심 표현을 권장드려요.'}
                      {data.memberBase?.social_grade <= 4 &&
      ...
      >
        ...
        <View style={modalStyle.modalBody}>
          <SpaceView mb={16}>
            <CommonText textStyle={_styles.reportText}>
              신고사유를 알려주시면 더 좋은 리미티드를 만드는데 도움이 됩니다.
            </CommonText>
          </SpaceView>
