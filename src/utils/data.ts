...
// 보관함 전달 데이터 구성
export const getStorageListData = (list: [{req_member_seq: any, file_name: any, file_path: any, int_after_day: any, special_interest_yn: any}]) => {
	let arrayList = new Array();
	let dataList = new Array();
	let hNum = 0;
	list.map(({ req_member_seq, file_name, file_path, int_after_day, special_interest_yn } : { req_member_seq: any, file_name: any, file_path: any, int_after_day: any, special_interest_yn: any }) => {
