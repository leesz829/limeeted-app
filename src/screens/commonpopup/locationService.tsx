...
export const LocationService: FC<Props> = (props) => {
	return (
		<CommonText type={'h5'}>
			주식회사 앱스쿼드(이하 ‘회사’)는 여러분의 개인정보를 원활한 리미티드(LImeetED) 서비스(이하 ‘회사 서비스’)의 제공을 
			위해 여러분이 동의한 목적과 범위 내에서만 이용합니다. 회사는 여러분의 동의나 법률의 특별한 규정 등 개인정보 보호법에 해당하지 
			않는 경우 여러분의 개인정보를 절대 제삼자에게 제공하지 않습니다.{'\n'}
			{'\n'}
			{'\n'}
			제 1 조 (목적){'\n'}
			{'\n'}본 약관은 회원(본 약관에 동의한 자, 이하 ‘회원’)이 주식회사 앱스쿼드(이하 ‘회사’라고 합니다.)가 
			제공하는 리미티드(LImeetED) 서비스(이하 ‘회사 서비스’라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 
			책임사항을 규정함을 목적으로 합니다.{'\n'}
			{'\n'}
			{'\n'}
			제 2 조 (이용약관의 효력 및 변경){'\n'}
			{'\n'}본 약관은 서비스를 신청한 고객 또는 개인위치 정보주체가 본 약관에 동의하고 회사가 정한 소정의 절차에 따라 
			...
			서비스 명: 리미티드(LImeetED)
			{'\n'}
			서비스 내용: 유저 간 원하는 상대를 매칭하고 1:1 채팅 서비스를 제공, 또한 본인의 매력을 표현하는 소셜 데이팅 서비스
			{'\n'}
			위치정보 이용 내용: 위치를 이용한 매칭 서비스 제공{'\n'}
			{'\n'}
			{'\n'}
			제 5 조 (서비스 이용요금){'\n'}
			{'\n'}
			회사가 제공하는 서비스는 기본적으로 유료 또는 무료입니다.
			단, 별도의 유료 서비스의 경우 해당 서비스에 명시된 요금을 지불하여야 사용 가능합니다.{'\n'}
			{'\n'}
			...
			{'\n'}
			회사가 서비스 내용을 변경하거나 종료하는 경우 회사는 회원의 등록된 전자우편 주소로 이메일을 통하여 서비스 내용의 
			변경 사항 또는 종료를 통지할 수 있습니다.{'\n'}
			{'\n'}
			1항의 경우 불특정 다수인을 상대로 통지를 함에 있어서는 웹사이트 등 기타 회사의 공지사항을 통하여 회원들에게 통지할 수 있습니다.{'\n'}
			{'\n'}
			{'\n'}
			제 7 조 (서비스의 이용제한 및 중지){'\n'}
			{'\n'}
			...
			해당 자료는 1년간 보관합니다.{'\n'}
			{'\n'}
			통신 단말장치로 매회 회원에게 제공받는 자, 제공일시 및 제공목적을 즉시 통보합니다. 
			...
			제 9 조 (개인위치정보주체의 권리){'\n'}
			{'\n'}
			회원은 회사에 대하여 언제든지 개인위치정보를 이용한 위치기반서비스 제공 및 개인위치정보의 제3자 제공에 대한 동의의 전부 또는 일부를 
			철회할 수 있습니다. 이 경우 회사는 수집한 개인위치정보 및 위치정보 이용, 제공사실 확인자료를 파기합니다.{'\n'}
			{'\n'}
			회원은 회사에 대하여 언제든지 개인위치정보의 수집, 이용 또는 제공의 일시적인 중지를 요구할 수 있으며, 
			...
			제3자에게 제공하고자 하는 경우에는 14세 미만의 아동과 그 법정대리인의 동의를 받아야 합니다. 단, 아래의 경우는 제외합니다.{'\n'}
			{'\n'}
			...
			{'\n'}
			회사는 아래의 경우에 해당하는 자(이하 ‘8세 이하의 아동 등’)의 보호의무자가 8세 이하의 아동 등의 생명 또는 신체보호를 
			...
			금치산자{'\n'}
			{'\n'}
			장애인 복지법 제2조 제2항 제2호의 규정에 의한 정신적 장애를 가진 자로서
			장애인 고용 촉진 및 직업 재활법 제2조 제2호의 규정에 의한 중증장애인에 해당하는 자
			(장애인복지법 제29조의 규정에 의하여 장애인등록을 한 자에 한한다){'\n'}
			{'\n'}
			...
			{'\n'}
			회사는 개인위치정보를 적절히 관리 및 보호하고, 개인위치정보주체의 불만을 원활히 처리할 수 있도록 실질적인 책임을 질 수 있는 지위에 
			있는 자를 위치정보관리책임자로 지정해 운영하고 있으며, 위치정보관리책임자의 성명과 연락처는 아래와 같습니다.{'\n'}
			{'\n'}
			성명: 문현진
			{'\n'}
			이메일: limeeted@gmail.com{'\n'}
			{'\n'}
			{'\n'}
			제 13 조 (손해배상){'\n'}
			{'\n'}
			회사가 위치정보의 보호 및 이용 등에 관한 법률 제15조 내지 제26조의 규정을 위반한 행위로 회원에게 손해가 발생한 경우 
			회원은 회사에 대하여 손해배상 청구를 할 수 있습니다. 이 경우 회사는 고의, 과실이 없음을 입증하지 못하는 경우 책임을 면할 수 없습니다.{'\n'}
			{'\n'}
			...
			회원의 귀책	사유로 서비스 이용에 장애가 있는 경우{'\n'}
			{'\n'}
			제1호 내지 제3호를 제외한 기타 회사의 고의∙과실이 없는 사유로 인한 경우{'\n'}
			{'\n'}
			회사는 서비스 및 서비스에 게재된 정보, 자료, 사실의 신뢰도, 정확성 등에 대해서는 보증을 
			하지 않으며 이로 인해 발생한 회원의 손해에 대하여는 책임을 부담하지 아니합니다.{'\n'}
			{'\n'}
			{'\n'}
			제 15 조 (분쟁의 조정 및 기타){'\n'}
			{'\n'}
			회사는 위치정보와 관련된 분쟁에 대해 회사자간 협의가 이루어지지 아니하거나 협의를 할 수 없는 경우에는 
			위치정보의 보호 및 이용 등에 관한 법률 제28조의 규정에 의한 방송통신위원회에 재정을 신청할 수 있습니다.{'\n'}
			{'\n'}
			회사 또는 고객은 위치정보와 관련된 분쟁에 대해 회사자간 협의가 이루어지지 아니하거나 협의를 할 수 없는 경우에는 
			개인정보보호법 제43조의 규정에 의한 개인정보분쟁조정위원회에 조정을 신청할 수 있습니다.{'\n'}
			{'\n'}
			{'\n'}
			제 16 조 (회사의 연락처){'\n'}
			{'\n'}
			...
			상호 : 주식회사 앱스쿼드{'\n'}
			대표자 : 김성일{'\n'}
			주소 : 서울특별시 강서구 양천로738 한강G트리타워 302호{'\n'}
			메일: limeeted@gmail.com{'\n'}
			부칙{'\n'}
