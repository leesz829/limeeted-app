...
export const Preference: FC<Props> = (props) => {
				...
				if (response.data.result_code != '0000') {
					...
					if (null != response.data.result) {
						...
						response.data?.result?.map(
							({ group_code, common_code, code_name }: { group_code: any; common_code: any; code_name: any }) => {
	...
	return (
		<View style={layoutStyle.flex1}>
			...
			<Modalize ref={modalizeRef} handleStyle={modalStyle.modalHandleStyle} modalStyle={modalStyle.modalContainer}>
