...
export const Introduce = (props: Props) => {
  ...
  // 관심사 체크 목록
  const [checkIntList, setCheckIntList] = React.useState([
    { code_name: '', common_code: '', interest_seq: '' },
  ]);
                  ...
                  return (
                    <SpaceView key={i.common_code}>
                      <TouchableOpacity
                        style={[
                          styles.interestBox,
                          i.common_code === tmpCommonCode && styles.boxActive,
                        ]}
                        onPress={() => {
                          if (i.common_code === tmpCommonCode) {
                            setCheckIntList(
                              checkIntList.filter(
                                (value) => value.common_code != tmpCommonCode
                              )
                            );
                          } else {
