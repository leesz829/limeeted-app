...
export const SecondAuthPopup = (props: Props) => {
  ...
  if (type == 'JOB') {
    ...
    etcTxt02 =
      '허용 증명서 : 재직 증명서, 건강보헝 자격 득실 증명서, 직업 라이선스';
  } else if (type == 'EDU') {
    title = '학업';
    itemNm = '교육기관';
    placeholderTxt =
      '출신 교육기관을 입력해주세요. (예 : 서울대 컴퓨터 공학과)';
    etcTxt01 =
      '자신의 출식 대학교 또는 대학원 등의 재학증명서 또는 졸업 증명서 등을 올려주세요.';
    etcTxt02 =
      '그외의 고등 교육기관의 경우는 관리자의 주관적 판단에 의해 결정될 수 있으니 참고바랍니다.';
  } else if (type == 'INCOME') {
    title = '소득';
    etcTxt01 = '가장 최근의 급여 명세서를 올려주세요.';
    etcTxt02 =
      '직업 인증과 이름이 다를 경우 관리자의 판단에 따라 반려될 수 있으니 참고해주세요.';
  } else if (type == 'ASSET') {
    title = '자산';
    etcTxt01 =
      '은행에서 발급 받을 수 있는 잔고 증명서를 올려주세요. 잔고가 5억 이상인 경우 프로필 2차 인증을 승인 받을 수 있습니다.';
  } else if (type == 'SNS') {
    title = 'SNS';
    itemNm = '인스타ID';
    ...
    etcTxt01 =
      '소유차량을 증명할 수 있는 차량 등록등 또는 자동차 보험 가입 현황을 올려주세요.';
  }
    ...
    <View style={layoutStyle.flex1}>
      ...
      <View style={modalStyle.modalBody}>
        ...
        <SpaceView mb={24} viewStyle={layoutStyle.alignCenter}>
          <ImagePicker
            isBig={true}
            callbackFn={imgCallBackFn}
            uriParam={props.orgFileUrl}
          />
        </SpaceView>
