...
const Startpage = () => {
  ...
  return (
    <ScrollView contentContainerStyle={style.container}>
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('Title00')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view1}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('Signup00')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view2}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('Signup01')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view3}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('SignupPopUp')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view4}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('Signup03')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view6}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('SignupPopUp2')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view7}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate(STACK.TAB, { screen: 'Matching' })}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view9}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('CommonPopup')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view10}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('ReportPopup')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view12}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => navigation.navigate('LivePopup')}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view13}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => {
          navigation.navigate(STACK.TAB, { screen: 'Live' });
        }}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view14}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => {
          navigation.navigate(STACK.TAB, { screen: 'LiveSearch' });
        }}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view15}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => {
          navigation.navigate(STACK.TAB, { screen: 'Profile1' });
        }}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view22}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => {
          navigation.navigate(STACK.TAB, { screen: 'Profile2' });
        }}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view23}
          resizeMode={'contain'}
        />
      ...
      <TouchableOpacity
        style={style.pages}
        onPress={() => {
          navigation.navigate(STACK.TAB, { screen: 'StorageProfile' });
        }}
      >
        <Image
          style={style.pageImg}
          source={START_IMAGE.view25}
          resizeMode={'contain'}
        />
