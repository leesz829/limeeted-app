...
import { CommonCode, LabelObj, ProfileImg, FileInfo, ScreenNavigationProp} from '@types';
		...
		<>
			...
			<ScrollView>
				...
				<SpaceView viewStyle={styles.container} pt={48}>
					...
					{faceTypeList.length > 0 && <RadioCheckBox items={faceTypeList} callBackFunction={callBackFunction} />}
				</SpaceView>
			</ScrollView>
